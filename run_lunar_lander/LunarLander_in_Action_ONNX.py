...
def run_and_control_lunar_lander(
    ...
    *,
    ...
    """
    # Choose renderer
    env = gym.make("LunarLander-v3", render_mode="rgb_array", continuous=continuous, gravity=-10.0,
               enable_wind=True, wind_power=10.0, turbulence_power=1.2)
...
if __name__ == "__main__":
    ...
    MODEL_FILE_PATH = Path(
        "/home/pnguyen/Workspace/Northeastern_University/ReinforcementLearning_CS_5180/project/LunarLander-TabularTDLearning-To-DeepRL/training_output_lunar_lander/discrete/ppo_lunar_lander/trained_ppo_2026-04-22_01-33.onnx"
    )
